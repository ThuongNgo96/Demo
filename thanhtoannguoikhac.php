            ...
            <div class="col-12">
                <div class="row">
                    <div class=" col-6 offset-3 border-pay bg-success" style=" border-radius: 9px">
                        <h1 class=" text-center">Nhập Thông Tin Người nhận </h1>
                    </div>
                </div>
                <div class="d-flex justify-content-center">
                    <form class=" d-flex flex-column w-75" method="POST" action="./database/xulythanhtoannguoinhankhac.php">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="" type="text" name="tennguoinhan">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Địa chỉ người nhận:</label>
                            <input class="form-control" type="text" value="" name="diachi">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Số điện thoại:</label>
                            <input class="form-control" value="" type="text" name="sdt">
                        </div>
