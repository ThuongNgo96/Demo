                            ...
                            <table class=" table table-hover table-bordered">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col"> Giảm %</th>
                                        <th class="text-center" scope="col">Giá sau khi  giảm</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class=" border">
                                            ...
                                            <td class="text-center"><?php echo $row['GiamGia'] ?></td>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".edit").click(function() {
                ...
                swal({
                        title: "Bạn có chắc chắn",
                        text: "Bạn có muốn sửa sản pham này ! Bạn sẽ không thể hoàn tác lại thao tác này ! ",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
